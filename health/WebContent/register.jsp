                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="UserCadastro" method="post">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="exampleLastName" name="apelido"
                                            placeholder="Apelido">
                                    </div>
                                </div>
                                <div class="form-group">
                                <input type="date" class="form-control form-control-user" id="exampleLastName" name="dtNascimento"
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="login.jsp">Já tem uma conta? Clique aqui!</a>
                            </div>
                        </div>
                    </div>
                </div>
