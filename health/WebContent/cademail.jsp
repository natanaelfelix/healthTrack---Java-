                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Agora digite seu email e um nova senha!</h1>
                            </div>
                            <form class="user" action="Email" method="post">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user" id="exampleLastName" name="senha"
                                            placeholder="Senha">
                                    </div>
                                </div>
