                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Bem vindo! Você está a um passo de estar mais saudável!</h1>
                                    </div>
                                    ...
                                    <hr>
                                    <a class="btn btn-primary btn-user btn-block" href="register.jsp">Cadastrar</a>
                                </div>
                            </div>
                        </div>
                    </div>
