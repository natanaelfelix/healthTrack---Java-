    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion no-print" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center">
                ...
                <div class="sidebar-brand-text mx-3">HealthTrack</div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
                ...
                <div class="sidebar-heading">
                 ...
                 <li class="nav-item active">
                    <a class="nav-link" href="http://localhost:8080/health/Index?cod=${CodId}">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Sentimos que vocês eteja saindo, te esperamos em breve!</h1>
                                <h1 class="h4 text-gray-900 mb-4">Deletado com Sucesso!</h1>
                            </div>
                            <hr>
                            <form class="user">
                                <form class="user">
